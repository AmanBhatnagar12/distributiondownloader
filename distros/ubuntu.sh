...
then
       ...
       do
          if [ $tydosycb = "32bits" ];
                 then
                      urldedescarga="http://releases.ubuntu.com/saucy/ubuntu-13.10-desktop-i386.iso"
          elif [ $tydosycb = "64bits" ]
                  then
                      urldedescarga="http://releases.ubuntu.com/saucy/ubuntu-13.10-desktop-amd64.iso"
          fi
       done
fi
...
function DESCMAIN {
archinfo=`dirname $0`/ubuntu.html
zenity --text-info \
